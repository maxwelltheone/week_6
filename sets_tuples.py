...
# print("apple" in set2) #Boolean method (true)
...
# list1 = list(set1)
# print(list1[0])
# # we use sets when we want to store unique elemnts
# # and we don't care about the order of the elemets
...
# print(1 in set1) #Output: true
# print('banana' in set2) #Output: true
...
# Now get the name of the third person
